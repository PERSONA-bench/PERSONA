...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_key", type=str, choices=MODEL_CONFIGS.keys(), default="gpt-4.1-2025-04-14",
                        help="The key of the model to evaluate (e.g., 'gpt-4o-mini').")
    parser.add_argument("--jsonl_filepath", type=str, default="WithConversationPrompts_ScorePrediction_Refactored.jsonl",
                        help="Path to the .jsonl file containing evaluation prompts.")
    
    args = parser.parse_args()
    # WithConversationPrompts_PseudoRandomContext_ExactScorePrediction.jsonl
